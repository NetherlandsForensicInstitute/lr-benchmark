...
def test_refnorm():
    ...
    file = open("test_resources/refnormcohort.txt", "r")
    ...
    scorer_normalized = PrecalculatedScorerASR("test_resources/unittestrefnorm_normalizedscores.csv")
    # create a dataset and pair all measurements
    dataset_asr = ASRDataset("test_resources/unittestrefnorm_rawscores.csv", asr_config.meta_info_path)
